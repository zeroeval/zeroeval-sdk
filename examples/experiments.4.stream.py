...
def normal_step(row):
    ...
    client = openai.OpenAI(
        api_key="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"
    )
    response = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "user",
                "content": "Tell a 1 line story about a bear, start with 'Once upon a time'.",
            }
        ],
...
experiment = ze.Experiment(dataset=dataset, task=task, evaluators=[eval1])
